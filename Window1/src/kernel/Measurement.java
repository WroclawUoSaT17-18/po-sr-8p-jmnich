...
public class Measurement {
	...
	public void setSetPointParams(ObservableList<MeasurementParameter> newParams) {
		setPointParams = newParams;
	}
	
	public void setActualParams(ObservableList<MeasurementParameter> newParams) {
