...
import controllers.ControllerImpCurveCompare;
...
public class AppComponentsBank {
	...
	private static ControllerImpCurveCompare ctrlCurveCompare = null;
	...
	private static Stage stageCurveCompStage = null;
	...
	private static Scene sceneCurvecompare = null;
...
// ===============================================================================
	//  IMPEDANCE CURVE COMPARE SCENE
//================================================================================
	
	/**
	 * Sets the Curve Comp Scene reference. 
	 * First-time setting must never be changed. globalErrorFlag sets on an attempt
	 * to do so. 
	 * @param scene reference to an initialized Scene
	 */
	public static void setCurveCompScene(Scene scene) {
		if(sceneCurvecompare == null) {
			sceneCurvecompare = scene;
		} else {
			globalErrorFlag = true;
		}
	}
	...
	/**
	 * Getter for the impedance curve compare scene
	 * @return reference to the static main scene
	 */
	public static Scene getCurveCompScene() {
		return sceneCurvecompare;
	}
	
	/**
	 * Sets the curve compare controller reference. 
	 * First-time setting must never be changed. globalErrorFlag sets on an attempt
	 * to do so. 
	 * @param controller reference to an initialized controller
	 */
	public static void setCurveCompareController(ControllerImpCurveCompare controller) {
		if(ctrlCurveCompare == null) {
			ctrlCurveCompare = controller;
		} else {
			globalErrorFlag = true;
		}
	}
	...
	/**
	 * Getter for the curve compare controller
	 * @return reference to the static main scene
	 */
	public static ControllerImpCurveCompare getCurveCompareController() {
		return ctrlCurveCompare;
	}
...
// ===============================================================================
	...
	/**
	 * Sets the Curve Compare Stage reference. 
	 * First-time setting must never be changed. globalErrorFlag sets on an attempt
	 * to do so. 
	 * @param stage reference to an initialized stage
	 */
	public static void setCurveCompStage(Stage stage) {
		if(stageCurveCompStage == null) {
			stageCurveCompStage = stage;
		} else {
			globalErrorFlag = true;
		}
	}
	...
	/**
	 * Getter for the Curve Compare Stage
	 * @return reference to the stage
	 */
	public static Stage getCurveCompStage() {
		return stageCurveCompStage;
	}
