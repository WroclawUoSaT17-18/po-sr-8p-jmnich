...
public class AppKernel {
	...
	public String getDefaultFrequenciesForImpedanceCurve() {
		return appRegistryNode.get("impedance_curve_frequencies", "1 ; 5 ; 10 ; 20 ; 30 ; 50 ; 70 ; 100");
	}
	
	public void setDefaultFrequenciesForImpedanceCurve(String frequenciesForImpedanceCurve) {
		appRegistryNode.put("impedance_curve_frequencies", frequenciesForImpedanceCurve);
	}
	 
	public String getDefaultImpedanceCurveDataLocation() {
		return appRegistryNode.get("impedance_curve_data_path", "");
	}
	
	public void setDefaultImpedanceCurveDataLocation(String impedanceCurveDataLocation) {
		appRegistryNode.put("impedance_curve_data_path", impedanceCurveDataLocation);
	}
	...
	public void lockNonCommunicationInterface() {
		...
		AppComponentsBank.getControllerContextButtons().lockButtonsExceptCurve();
		
		AppComponentsBank.getControllerImpCurve().setInterfaceInNonCommunicationModeDisable(true);
	...
	public void unlockNonCommunicationInterface() {
		...
		AppComponentsBank.getControllerImpCurve().setInterfaceInNonCommunicationModeDisable(false);
	}
