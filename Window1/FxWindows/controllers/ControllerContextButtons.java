...
public class ControllerContextButtons {
	...
	public void btnCommunication(ActionEvent event) {
		...
		AppComponentsBank.getControllerImpSingle().setControllerEnable(false);
		AppComponentsBank.getControllerImpCurve().setControllerEnable(false);
	...
	public void btnImpCurve(ActionEvent event) {
		...
		AppComponentsBank.getControllerImpSingle().setControllerEnable(false);
		AppComponentsBank.getControllerImpCurve().setControllerEnable(true);
	...
	public void btnImpSingle(ActionEvent event) {
		...
		AppComponentsBank.getControllerImpSingle().setControllerEnable(true);
		AppComponentsBank.getControllerImpCurve().setControllerEnable(false);
	...
	public void lockButtonsExceptCurve() {
		btnComm.setDisable(false);
		btnMaintenance.setDisable(true);
		btnCurrentMeas.setDisable(true);
		btnImpSingle.setDisable(true);
